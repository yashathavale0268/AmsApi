...
namespace AmsApi.Controllers
{
    ...
    public class VendorController : ControllerBase
    {
        ...
        // GET api/values/5
        [HttpGet("GetAllVendors")]
        public async Task<ActionResult<IEnumerable<VendorModel>>> SearchVendors([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 5, [FromQuery] string searchTerm = null,[FromQuery]String StartDate=null,[FromQuery] String EndDate = null,[FromQuery] int DateFilter=0)
        {
            var msg = new Message();
            var Vendors = await _repository.SearchVendors(pageNumber, pageSize, searchTerm,StartDate,EndDate, DateFilter);
            if (Vendors.Count>0) {
                msg.IsSuccess = true;
                msg.Data = Vendors;
            }
